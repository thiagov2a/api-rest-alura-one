...
class ConsultaControllerTest {
    ...
    void agendarEscenario2() throws Exception {
        ...
        var datos = new DatosRespuestaConsulta(null, 2l, 5l, fecha, null);
        ...
        var response = mvc.perform(post("/consultas")
                ...
                .content(agendarConsultaJacksonTester.write(new DatosAgendarConsulta(null, 2l, 5l, especialidad, fecha)).getJson())
